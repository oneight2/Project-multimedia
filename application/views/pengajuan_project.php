<body class="bg-gradient-primary pengajuan">
    <div class="container">
                        ...
                        <div class="p-5">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <input type="text" class="form-control " id="exampleFirstName" placeholder="Nama" name="nama">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" id="exampleInputEmail" placeholder="Judul Project" name="judul_project">
                            ...
                            <div class="form-group">
                                <input type="file" class="custom-file-input" id="upload-storyboard" aria-describedby="inputGroupFileAddon01" name="storyboard" data-show-upload="false" data-browse-on-zone-click="true">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    ...
                                    <input type="date" class="form-control" id="exampleRepeatPassword" placeholder="Target Project" name="waktu">
                                    <?= form_error('waktu', '<small class="text-danger pl-3">', '</small>'); ?>
                                </div>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" id="exampleInputEmail" placeholder="Link Contoh Project" name="link">

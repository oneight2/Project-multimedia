            ...
            <script>
              ...
              $(document).ready(function(){
                            ...
                            function show_product(){
                                $.ajax({
                                    type  : 'GET',
                                    url   : '<?php echo site_url('PengajuanCimanggis/product_data')?>',
                                    async : false,
                                    dataType : 'json',
                            ...
                            function show_product_selesai(){
                                $.ajax({
                                    type  : 'GET',
                                    url   : '<?php echo site_url('PengajuanCimanggis/product_data_selesai')?>',
                                    async : false,
                                    dataType : 'json',
                                    contentType: "application/json",
                                    success : function(data){                               
                            ...
                            function showPegawai(){
                                $.ajax({
                                    type  : 'GET',
                                    url   : '<?php echo site_url('PengajuanCimanggis/data_pegawai')?>',
                                    async : false,
                                    dataType : 'json',
                                    contentType: "application/json",
                                    success : function(data){
                            ...
                            //update record to database
                             $('#btn_update').on('click',function(){
                                ...
                                $.ajax({
                                    type : "POST",
                                    url  : "<?php echo site_url('PengajuanCimanggis/update')?>",
                                    dataType : "JSON",
                            ...
                            //delete record to database
                             $('#btn_delete').on('click',function(){
                                ...
                                $.ajax({
                                    type : "POST",
                                    url  : "<?php echo site_url('PengajuanCimanggis/delete')?>",
                                    dataType : "JSON",
